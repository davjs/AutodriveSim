...
namespace CxxTest
{
    ...
    : _suite(NULL), _line(0), _testName(NULL)
    {
    }
    ...
    : _file(NULL), _line(0), _suiteName(NULL), _tests(NULL) {}
    ...
    StaticSuiteDescription::StaticSuiteDescription() : _suite(NULL) {}
    StaticSuiteDescription::StaticSuiteDescription( const char *argFile, unsigned argLine,
                                                    ...
                                                    List &argTests ) :
        RealSuiteDescription( argFile, argLine, argSuiteName, argTests ), _suite(NULL)
    {
