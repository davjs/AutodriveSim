...
namespace hesperia {
    namespace scenegraph {
        namespace models {
            ...
            SimpleCar::SimpleCar(const SceneNodeDescriptor &sceneNodeDescriptor, const double &length, const double &width, const core::data::environment::Point3 &position, const double &rotZ, const core::data::environment::Point3 &color, const float &height) :
            ...
            void SimpleCar::setPosition(const core::data::environment::Point3 &positionCenter, const double &rotZ) {
                ...
                rearLeft.rotateZ(rotZ + 90*Constants::DEG2RAD);

                Point3 rearRight(m_width/2.0, 0, 0);
                rearRight.rotateZ(rotZ - 90*Constants::DEG2RAD);
