...
namespace hesperia {
    ...
    Camera::Camera() :
        ...
        m_orientation(0,0,0),
        m_up(0,0,0),
        m_head(static_cast<float>(-core::data::Constants::PI)+0.1),
        m_pitch(static_cast<float>(-core::data::Constants::PI / 4)),
        m_roll(0)
    {}
    ...
    void Camera::apply()
    {
        ...
        m_pitch = (m_pitch < -core::data::Constants::PI) ? -core::data::Constants::PI : m_pitch;
