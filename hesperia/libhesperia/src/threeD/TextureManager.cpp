...
namespace hesperia {
    namespace threeD {
        ...
        void TextureManager::removeTexture(const string &name) {
            map<string, uint32_t, core::wrapper::StringComparator>::iterator it = m_mapOfTextureHandles.find(name);
        ...
        int32_t TextureManager::getTexture(const string &name) const {
            ...
            map<string, uint32_t, core::wrapper::StringComparator>::const_iterator it = m_mapOfTextureHandles.find(name);
            if (it != m_mapOfTextureHandles.end()) {
