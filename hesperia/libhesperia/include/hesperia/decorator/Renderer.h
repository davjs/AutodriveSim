    ...
    namespace decorator {
        ...
        class OPENDAVINCI_API Renderer {
            ...
            public:
                 ...
                 */
                virtual void drawPolyLine(const vector<core::data::environment::Point3> &listOfPoints) = 0;
                 ...
                 * @param h height
                 */
                virtual void drawPolyLine(const vector<core::data::environment::Point3> &listOfPoints, const double &height) = 0;
                 ...
                 */
                virtual void drawTriangleSet(const hesperia::decorator::models::TriangleSet &ts, const core::data::environment::Point3 &position, const core::data::environment::Point3 &rotation) = 0;
                 ...
                 * @param rotation Rotation.
                 */
                virtual void drawListOfTriangleSets(const vector<hesperia::decorator::models::TriangleSet> &listOfTriangleSets, const core::data::environment::Point3 &position, const core::data::environment::Point3 &rotation) = 0;
        };
