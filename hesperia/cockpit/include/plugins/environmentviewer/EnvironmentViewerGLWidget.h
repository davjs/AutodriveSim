...
namespace cockpit {
    namespace plugins {
        namespace environmentviewer {
             ...
             */
            class EnvironmentViewerGLWidget : public AbstractGLWidget, public core::io::ContainerListener, public SelectableNodeDescriptorTreeListener {
                private:
                    /**
                ...
                private:
                    ...
                    map<hesperia::threeD::NodeDescriptor, core::data::environment::Position, hesperia::threeD::NodeDescriptorComparator> m_mapOfCurrentPositions;
