...
namespace cockpit {
    namespace plugins {
        namespace birdseyemap {
             ...
             */
            class BirdsEyeMapMapWidget : public QWidget, public core::io::ContainerListener, public SelectableNodeDescriptorTreeListener {
                ...
                private:
                    ...
                    core::data::environment::Point3 m_centerOfMap;
                    core::data::environment::Point3 m_mouseOld;
