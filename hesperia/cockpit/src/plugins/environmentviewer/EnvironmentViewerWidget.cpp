        ...
        namespace environmentviewer {
            ...
            void EnvironmentViewerWidget::selectedItemChangedBackground(const QString &item) {
                if (item.toStdString() == "black") {
                    m_environmentViewerGLWidget->setBackgroundColor(core::data::environment::Point3(0, 0, 0));
                }
                if (item.toStdString() == "white") {
                    m_environmentViewerGLWidget->setBackgroundColor(core::data::environment::Point3(1, 1, 1));
                }
            }
