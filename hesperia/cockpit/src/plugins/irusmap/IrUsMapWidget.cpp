        ...
        namespace irusmap {
            ...
            void IrUsMapWidget::nextContainer(Container &c) {
                if (c.getDataType() == Container::USER_DATA_0) {
        			...
        			m_sensorBoardData = c.getData<msv::SensorBoardData>();
                }
            }
            ...
            void IrUsMapWidget::paintEvent(QPaintEvent *evt) {
                ...
                // The code for drawing the underlying coordinate system was inspired from Benjamin Vetter's code to draw Gulliver 1:8 scale cars.
