...
namespace cockpit {
    namespace plugins {
        ...
        AbstractGLWidget::AbstractGLWidget(const PlugIn &plugIn, QWidget *prnt) :
                ...
                m_pitchZ(0),
                m_scale(1),
                m_phi(static_cast<float>(-core::data::Constants::PI)),
                m_theta(static_cast<float>(-core::data::Constants::PI / 4)),
                m_epsilon(0),
            ...
            m_phi = -core::data::Constants::PI + 0.1;
        ...
        void AbstractGLWidget::setBackgroundColor(const core::data::environment::Point3 &c) {
        ...
        void AbstractGLWidget::paintGL() {
            ...
            m_theta = (m_theta < -core::data::Constants::PI) ? -core::data::Constants::PI : m_theta;
