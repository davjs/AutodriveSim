...
namespace context {
    namespace base {
        ...
        void ControlledContainerConferenceFactory::add(core::io::ContainerListener *cl) {
            if (cl != NULL) {
        ...
        ContainerConference* ControlledContainerConferenceFactory::getContainerConference(const string &address, const uint32_t &port) {
            ...
            ControlledContainerConferenceForSystemUnderTest *ccc = new ControlledContainerConferenceForSystemUnderTest(address, port, *blockableContainerReceiverFromSystemUnderTest, *containerDelivererToSystemUnderTest);
