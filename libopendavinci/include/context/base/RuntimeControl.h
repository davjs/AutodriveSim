...
namespace context {
    namespace base {
         ...
         */
        class OPENDAVINCI_API RuntimeControl : public core::base::AbstractModule {
            public:
                enum RUNTIMECONTROL {
                    UNSPECIFIED,
                    DONT_TAKE_CONTROL,
            ...
            private:
                 ...
                 * ConferenceClientModuleRunners.
                 *
                 * @param rte RuntimeEnvironment
                 * @return List of wrapped ConferenceClientModules.
                 */
                vector<core::SharedPointer<ConferenceClientModuleRunner> > createListOfConferenceClientModuleRunners(RuntimeEnvironment &rte);
