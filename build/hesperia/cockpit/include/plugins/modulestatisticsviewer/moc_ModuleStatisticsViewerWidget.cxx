...
#include "../../../../../../hesperia/cockpit/include/plugins/modulestatisticsviewer/ModuleStatisticsViewerWidget.h"
...
void *cockpit::plugins::modulestatisticsviewer::ModuleStatisticsViewerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "core::io::ContainerListener"))
        return static_cast< core::io::ContainerListener*>(const_cast< ModuleStatisticsViewerWidget*>(this));
