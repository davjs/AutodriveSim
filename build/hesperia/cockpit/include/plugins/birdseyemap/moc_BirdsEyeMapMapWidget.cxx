...
#include "../../../../../../hesperia/cockpit/include/plugins/birdseyemap/BirdsEyeMapMapWidget.h"
...
void *cockpit::plugins::birdseyemap::BirdsEyeMapMapWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "core::io::ContainerListener"))
        return static_cast< core::io::ContainerListener*>(const_cast< BirdsEyeMapMapWidget*>(this));
